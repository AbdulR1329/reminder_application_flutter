...
import 'package:reminder_application/Screens/auth/login_screen.dart'; // Uncomment later
            ...
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.favorite_border_rounded, size: 32, color: Color(0xFF2C3E50)),
                            ),
                            ...
                            const Text(
                              "Relive beautiful moments exactly when they're meant to be experienced. Nostalgia at its finest.",
                              textAlign: TextAlign.center,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      onTap: () => Navigator.pop(context), // Goes back to Screen 2
                      child: Container(
